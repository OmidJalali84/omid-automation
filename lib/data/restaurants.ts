  ...
  kaktus: {
    ...
    items: {
      'غذای ایرانی': [
        ...
        { id: 4, name: 'چلو تاوا کبابی', price: 210000, image: '', available: true },
      ],
      'فست فود': [
      ...
      'پیتزا': [
        { id: 8, name: 'پیتزا مخلوط', price: 100000, image: '', available: true },
        { id: 9, name: 'پیتزا پپرونی', price: 120000, image: '', available: true },
        { id: 10, name: 'پیتزا مرغ', price: 120000, image: '', available: true },
      ],
      'صبحانه': [
